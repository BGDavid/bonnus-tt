 ...
 */
class MSliderItem extends \Magento\Framework\View\Element\Template
{
    
    /**
     * template for flex slider.
     */
    const STYLESLIDE_FLEXSLIDER_TEMPLATE = 'Unicodesystems_Bannerslider::slider/m_flexslider.phtml';
